...
echo -ne "
-------------------------------------------------------------------------
                    Instalacja Sterownikow grafiki
-------------------------------------------------------------------------
"
...
if ! source $HOME/ArchTitus/configs/setup.conf; then
	...
	while true
	do 
		read -p "Proszę podaj nazwę urzytkownika" username
...
echo "username=${username,,}" >> ${HOME}/ArchTitus/configs/setup.conf
    ...
    #Set Password
    read -p "Proszę podaj hasło:" password
echo "password=${password,,}" >> ${HOME}/ArchTitus/configs/setup.conf

    # Loop through user input until the user gives a valid hostname, but allow the user to force save 
	while true
	do 
		read -p "proszę ponaj nazwę maszyny:" name_of_machine
